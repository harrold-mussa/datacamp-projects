...
**Objective:** Built a data engineering project portfolio to solidify my practical skills and experience across the modern data stack, focusing on ingestion, transformation, orchestration, and cloud infrastructure.
...
* **Python (Pandas, NumPy, Built-in Modules):** Developed efficient data processing and cleaning scripts. Leveraged **Pandas** for high-performance data manipulation (mainly ETL), **NumPy** for vectorized operations, and native Python built-in modules for file handling, logging, and application logic.
...
* **Cloud Infrastructure & Deployment (AWS & GCP):** Applied fundamental knowledge of cloud services for data storage (S3/GCS), compute (EC2/Cloud Compute), and integration points for data pipeline deployment on both **AWS** and **GCP** environments.
